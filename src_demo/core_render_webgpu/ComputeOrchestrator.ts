/**
 * QuantaAI — ComputeOrchestrator.ts
...
import { webgpuComputeDriver } from './webgpu_compute_driver.ts';
import { webnnEngine } from './WebNNEngine.ts';
import { smartDataSplicer } from '../utils/smartDataSplicer.ts';
