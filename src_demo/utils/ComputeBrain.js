// src_demo/utils/ComputeBrain.js

import { executeWGSLCompute } from './gpuCompute.js';
import { executeWASMCompute } from './wasmCompute.js';
import { executeCPUCompute } from './cpuCompute.js';
...
class ComputeBrainEngine {
  ...
  async dispatch(indicatorType, candles, params = {}) {
    ...
    try {
      ...
      // Convert Float32Array back to array of objects for App.jsx backward compatibility
