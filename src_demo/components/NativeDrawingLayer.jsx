...
import { Canvas2DDrawings } from '../core_render_canvas2d/Canvas2DDrawings.js';
import { WebGLDrawings } from '../core_render_webgl/WebGLDrawings.js';
import { WebGPUDrawings } from '../core_render_webgpu/WebGPUDrawings.js';
...
const NativeDrawingLayer = forwardRef(({
  ...
  // Expose an imperative draw method to App.jsx for high-frequency rendering without React overhead
